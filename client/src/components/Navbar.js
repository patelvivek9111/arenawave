        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center group">
            <div className="relative">
              <span className="text-2xl md:text-3xl font-bold gradient-text group-hover:scale-105 transition-transform duration-300">
                ArenaWave
              </span>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200/50 bg-white/95 backdrop-blur-md rounded-b-2xl shadow-lg animate-slide-up">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <Link
                to="/"
                className="text-gray-700 hover:text-primary-600 block px-3 py-2 rounded-lg text-base font-medium transition-all duration-300 hover:bg-primary-50"
              ...
              <Link
                to="/cart"
                className="text-gray-700 hover:text-primary-600 block px-3 py-2 rounded-lg text-base font-medium transition-all duration-300 hover:bg-primary-50 relative"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Cart
                {getTotalItems() > 0 && (
                  <span className="absolute top-2 right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center animate-bounce-gentle shadow-lg">
                    {getTotalItems()}
                  </span>
                )}
              </Link>
